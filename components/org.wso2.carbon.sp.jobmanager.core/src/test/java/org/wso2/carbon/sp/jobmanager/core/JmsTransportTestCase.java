...
public class JmsTransportTestCase {
    ...
    public void testSiddhiTopologyCreator() {
        ...
        String siddhiApp = "@App:name('Energy-Alert-App')\n"+
                ...
                "'test', subject = 'High power consumption of {{deviceID}}', @map(type = 'xml', @payload('Device ID: {{deviceID}} of"+
    ...
    public void testGroupsWithInconsistentParalleleism(){
        String siddhiApp = "@App:name('MB-Testcase-2')\n"+
    ...
    public void testMultipleInMemoryTableReference(){
        ...
        try {
            ...
            Assert.assertTrue(e.getMessage().contains("In-Memory Table referenced from more than one execGroup: execGroup"));
    ...
    public void testMultiplePartitionExecGroup(){
        String siddhiApp = "@App:name('MB-Testcase-7')\n" +
    ...
    public void testJoinWithPartition() {
        ...
        try {
            ...
            Thread.sleep(1000);
            try {
                jmsTopicPublisher.publishMessage("TestPlan6_RegulatorStream", "<events><event><deviceID>1</deviceID><roomNo>100</roomNo>" +
                        "<isOn>false</isOn></event></events>)");
                jmsTopicPublisher.publishMessage("TestPlan6_RegulatorStream","<events><event><deviceID>2</deviceID><roomNo>101</roomNo>" +
                                "<isOn>false</isOn></event></events>");
            }catch (Exception e){
                System.out.println(e.getMessage());
            }
    ...
    public void testPartitionStrategy() {
       ...
       // KafkaTestUtil.createTopic(topics, 1);
        ...
        try {
            ...
            Thread.sleep(1000);
            try {
                jmsTopicPublisher.publishMessage("TestPlan7_RegulatorStream", "<events><event><deviceID>1</deviceID><roomNo>100</roomNo>" +
                        "<isOn>false</isOn></event></events>");
                jmsTopicPublisher.publishMessage("TestPlan7_RegulatorStream", "<events><event><deviceID>2</deviceID><roomNo>101</roomNo>" +
                                "<isOn>false</isOn></event></events>");
            }catch (Exception e){
                System.out.println(e.getMessage());
            }
    ...
    public void testUsergivenSourceNoGroup() {
        ...
        try {
            ...
            InMemoryBroker.publish("stock", "{\"event\":{\"symbol\":\"WSO2\", \"price\":225.0, \"quantity\":20," +
                    " \"tier\":\"middleware\"}}");
    ...
    @Test
    public void testPassthrougInvocForSingleGroup(){
    ...
    public void testPassThroughFix6(){
        ...
        Assert.assertTrue(queryGroupList.get(1).getSiddhiQueries().get(0).getApp().contains("@App:name('MB_Testcase_5-001-1') \n" +
                "@source(type='jms', factory.initial='org.wso2.andes.jndi.PropertiesFileInitialContextFactory',provider.url='../../resources/jndi.properties',connection.factory.type='queue',destination ='MB_Testcase_5_Test1Stream_0' , connection.factory.jndi.name='QueueConnectionFactory',@map(type ='xml')) \n" +
                "define stream Test1Stream (name string, amount double,value double);\n" +
                "@sink(type='jms', factory.initial='org.wso2.andes.jndi.PropertiesFileInitialContextFactory',provider.url='../../resources/jndi.properties', @distribution(strategy='partitioned', partitionKey='amount',@destination(destination = 'MB_Testcase_5_Test2Stream_amount_0'),@destination(destination = 'MB_Testcase_5_Test2Stream_amount_1'),@destination(destination = 'MB_Testcase_5_Test2Stream_amount_2'),@destination(destination = 'MB_Testcase_5_Test2Stream_amount_3')),connection.factory.type='topic', connection.factory.jndi.name='TopicConnectionFactory',@map(type='xml'))\n" +
                "@sink(type='jms', factory.initial='org.wso2.andes.jndi.PropertiesFileInitialContextFactory',provider.url='../../resources/jndi.properties',connection.factory.type='topic',destination = 'MB_Testcase_5_Test2Stream', connection.factory.jndi.name='TopicConnectionFactory', @map(type='xml'))define stream Test2Stream (name string, amount double, value double);\n" +
                "@info(name = 'query1')\n" +
                "from Test1Stream\n" +
                "select name,amount,value\n" +
                "insert into Test2Stream;"),"Incorrect query generated");
        Assert.assertTrue(queryGroupList.get(0).getSiddhiQueries().get(0).getAppName().contains(SiddhiTopologyCreatorConstants.PASSTHROUGH));
        ...
        Assert.assertTrue(queryGroupList.get(0).getSiddhiQueries().get(0).getApp().contains("@source(type = 'http', receiver.url='https://0.0.0.0:9550/SweetProductionEP', @map(type = 'json'))\n" +
                        ...
                        "@sink(type='jms', factory.initial='org.wso2.andes.jndi.PropertiesFileInitialContextFactory',provider.url='../../resources/jndi.properties',connection.factory.type='queue',destination = 'MB_Testcase_5_Test1Stream_0', connection.factory.jndi.name='QueueConnectionFactory', @map(type='xml'))\n" +
                        "@sink(type='jms', factory.initial='org.wso2.andes.jndi.PropertiesFileInitialContextFactory',provider.url='../../resources/jndi.properties', @distribution(strategy='partitioned', partitionKey='name',@destination(destination = 'MB_Testcase_5_Test1Stream_name_0'),@destination(destination = 'MB_Testcase_5_Test1Stream_name_1'),@destination(destination = 'MB_Testcase_5_Test1Stream_name_2')),connection.factory.type='topic', connection.factory.jndi.name='TopicConnectionFactory',@map(type='xml')) \n" +
                        "define stream Test1Stream (name string, amount double,value double);\n" +

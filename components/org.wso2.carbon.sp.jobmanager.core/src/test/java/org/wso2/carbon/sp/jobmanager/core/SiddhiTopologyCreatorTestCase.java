...
public class SiddhiTopologyCreatorTestCase {
    ...
    @Test
    public void testSiddhiTopologyCreator2() {
     ...
     */
    @Test(dependsOnMethods = "testSiddhiTopologyCreator")            //done
     ...
     */
    @Test(dependsOnMethods = "testFilterQuery") //done
     ...
     */
    @Test(dependsOnMethods = "testPartitionWithWindow") //done
     ...
     */
    @Test(dependsOnMethods = "testPartitionWithSequence")  //done
     ...
     */
    @Test(dependsOnMethods = "testPartitionWithPattern")   //done
     ...
     */
    @Test(dependsOnMethods = "testJoinWithPartition")           //done
     ...
     */
    @Test(dependsOnMethods = "testPartitionStrategy")           //done
     ...
     */
    @Test(dependsOnMethods = "testPartitionMultiSubscription")       //done
     ...
     * creation
     */
    @Test(dependsOnMethods = "testPartitionWithMultiKey")           //done
     ...
     * source.
     */
    @Test(dependsOnMethods = "testUserDefinedSink")    //done
    ...
    @Test(dependsOnMethods = "testSinkStreamForSource")        //done
    ...
    private Map<String, List<SiddhiAppRuntime>> createSiddhiAppRuntimes(                 //test util

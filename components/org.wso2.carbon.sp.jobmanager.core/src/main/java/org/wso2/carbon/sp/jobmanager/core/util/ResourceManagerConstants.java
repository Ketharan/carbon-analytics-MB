...
public class ResourceManagerConstants {
    ...
    //original destination annotation should have been commented
    public static final String DESTINATION = "@destination(destination = '${" + PARTITION_TOPIC + "}')";



    public static final String DEFAULT_MB_TOPIC_SOURCE_TEMPLATE = "@source(type='jms', factory.initial='org.wso2.andes.jndi.PropertiesFileInitialContextFactory'," +
    ...
    public static final String DEFAULT_MB_QUEUE_SOURCE_TEMPLATE = "@source(type='jms', factory.initial='org.wso2.andes.jndi.PropertiesFileInitialContextFactory'," +
    ...
    public static final String DEFAULT_MB_TOPIC_SINK_TEMPLATE = "@sink(type='jms', factory.initial='org.wso2.andes.jndi.PropertiesFileInitialContextFactory'," +
            "provider.url='../../resources/jndi.properties',connection.factory.type='topic'," +
            "destination = '${"+ MB_DESTINATION  +  "}', connection.factory.jndi.name='TopicConnectionFactory', @map(type='" + MAPPING + "'))";

    public static final String DEFAULT_MB_QUEUE_SINK_TEMPLATE = "@sink(type='jms', factory.initial='org.wso2.andes.jndi.PropertiesFileInitialContextFactory'," +
            "provider.url='../../resources/jndi.properties',connection.factory.type='queue'," +
            "destination = '${"+ MB_DESTINATION  +  "}', connection.factory.jndi.name='QueueConnectionFactory', @map(type='" + MAPPING + "'))";

    public static final String PARTITIONED_MB_SINK_TEMPLATE = "@sink(type='jms', factory.initial='org.wso2.andes.jndi.PropertiesFileInitialContextFactory'," +
            "provider.url='../../resources/jndi.properties', @distribution(strategy='partitioned', partitionKey='${" + PARTITION_KEY + "}'," +
            "${" + DESTINATIONS + "}),connection.factory.type='topic', connection.factory.jndi.name='TopicConnectionFactory'," +
            "@map(type='" + MAPPING + "'))";
